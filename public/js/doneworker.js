...
checkuser(urlpro+'/checkuserworker').then((data)=>
    ...
    getrequests(urlpro+'/donerequestworker')
    ...
    async function checkuser(url){
     ...
     async function setrequest(json){
        ...
        { 
                ...
                nameList += '<li style="list-style-type: none;">'+'<h1>'+' Done Avarage : ' + json[I].doneaverage + '</h1>'+ '</li>';
                ...
                colorlib.innerHTML +='<div class="hire">'+ '<div  class="card">'+nameList+'</div>'+'</div>';
